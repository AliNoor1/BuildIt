...
![basic model](references/MarkdownIMG/lr-branches-2.png){:height="300px" width="400px"}
...
![gitflow model](/references/MarkdownIMG/git-model.png){:height="300px" width="400px"}
